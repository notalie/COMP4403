...
public abstract class StatementNode {
    ...
    /**
     * Tree node representing a "repeat" statement.
     */
    public static class RepeatNode extends StatementNode {
        private ExpNode condition;
        private final StatementNode loopStmt;

        public RepeatNode(Location loc, StatementNode loopStmt, ExpNode condition) {
            super(loc);
            this.condition = condition;
            this.loopStmt = loopStmt;
        }
        ...
        @Override
        public String toString(int level) {
            return "REPEAT " + loopStmt.toString(level + 1) + " UNTIL" +
