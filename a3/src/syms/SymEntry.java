...
public abstract class SymEntry {
    ...
    public static class ParamEntry extends VarEntry {
        ...
        /*
         * Constructor when there is a default expression
         */
        public ParamEntry(String id, Location loc, Type type, boolean isRef, ExpNode defaultExp) {
            this(id, loc, type, isRef);
        ...
        /**
         * Returns the default expression (may be null)
         */
        public ExpNode getDefaultExp() {
            return defaultExp;
        }

        public void setDefaultParam(ExpNode exp) {
            this.defaultExp = exp;
        }
