...
public abstract class StatementNode {
    ...
    public static class CallNode extends StatementNode {
        ...
        public List<ExpNode> getParams() { return this.paramList; }

        public void setParams(List<ExpNode> newParams) { this.paramList = newParams; }

        @Override
        public String toString(int level) {
            if (this.paramList != null) {
                String paramListString = "";
                for (ExpNode param : this.paramList) {
                        paramListString += param.toString();
                }
                StringBuilder s = new StringBuilder("CALL " + id);
                return s + ") with params ["  + paramListString + "]";
            } else {
                StringBuilder s = new StringBuilder("CALL " + id);
                return s + ") with no params";
            }
        }
    }
